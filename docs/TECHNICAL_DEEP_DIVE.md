...
1. **"What are the top 3 technical challenges the team is facing right now?"**  
   *Why*: Understand priorities, see if your skills align.

2. **"How does this role fit into the team's roadmap for the next 6-12 months?"**  
   *Why*: Gauge impact, growth potential.

3. **"What does success look like in this role after 6 months?"**  
   *Why*: Clarify expectations, define measurable outcomes.

4. **"What's the team structure? Who would I work with closely?"**  
   *Why*: Understand collaboration, reporting lines.

5. **"What's the balance between feature development, infrastructure work, and technical debt?"**  
   *Why*: Understand day-to-day work distribution.

### About Technical Stack

6. **"What's the current tech stack, and are there plans to migrate or adopt new technologies?"**  
   *Why*: Assess if you'll work with modern tools, learning opportunities.

7. **"How do you approach technical decision-making? (Centralized vs. team-driven)"**  
   *Why*: Understand autonomy, decision-making culture.

8. **"What's the deployment process? (CI/CD, manual, feature flags)"**  
   *Why*: Gauge engineering maturity.

9. **"How do you handle production incidents? On-call rotation?"**  
   *Why*: Understand operational expectations.

### About Engineering Culture

10. **"How does the team approach code reviews and knowledge sharing?"**  
    *Why*: Assess collaboration quality.

11. **"What's the policy on technical debt? How do you balance it with new features?"**  
    *Why*: Understand long-term sustainability.

12. **"How do you measure engineering success? (Velocity, uptime, code quality)"**  
    *Why*: Understand what's valued.

13. **"What opportunities are there for learning and professional development?"**  
    *Why*: Assess growth opportunities.

### About the Business

14. **"What's the company's biggest technical or business challenge right now?"**  
    *Why*: Understand strategic priorities.

15. **"How does the engineering team interact with product/sales/customers?"**  
    *Why*: Assess cross-functional collaboration.

16. **"What's the company's approach to AI/ML? Is this project representative or an outlier?"**  
    *Why*: Gauge if AI work is core or experimental.
...
**Day 1: Code Review**
- [ ] Re-read all service classes (RAGService, RetrievalService, LLMService)
- [ ] Trace one full request from frontend to backend
- [ ] Review test files (especially test_document_authorization.py)
- [ ] Understand failure modes (What if Qdrant is down?)

**Day 2: Question Practice**
- [ ] Practice 2-minute explanation (record yourself)
- [ ] Practice 5-minute architecture walkthrough
- [ ] Prepare answers to "Why this technology?" for all components
- [ ] List 3 things you'd improve

**Day 3: Mental Preparation**
- [ ] Review this document (skim, not deep dive)
- [ ] Prepare questions for CTO (from "Questions to Ask" section)
- [ ] Get good sleep

### Day of Interview

**Morning**:
- [ ] Review architecture diagrams (1 hour)
- [ ] Run the demo locally (ensure everything works)
- [ ] Prepare backup (screenshots if live demo fails)

**30 Minutes Before**:
- [ ] Close all distractions
- [ ] Have architecture diagram open in browser
- [ ] Have codebase open in VS Code (for reference)

**During Interview**:
- **Be honest**: If you don't know something, say so (don't fake it)
- **Be specific**: Use actual file names, line numbers when discussing code
- **Be pragmatic**: Acknowledge trade-offs (POC vs. production)
- **Be confident**: You built this, you understand it

### Don't Get Stuck On

- **Perfect Explanations**: It's okay to simplify. You can always go deeper if asked.
- **Memorizing Code**: Understand the concepts, not every line.
- **Defending Every Decision**: If something was a mistake, own it and explain what you'd do differently.

### Quality Rules

**Rule 1**: **Accuracy > Confidence**  
Better to say "I'm not sure, but I think..." than to be confidently wrong.

**Rule 2**: **Clarity > Complexity**  
Explain like the CTO is smart but not familiar with your exact setup. Avoid jargon unless necessary.

**Rule 3**: **Honesty > Perfection**  
"This is a POC limitation" is better than pretending it's production-ready.

**Rule 4**: **Outcomes > Effort**  
Talk about what the system does (users can query securely), not how hard it was to build.

**Rule 5**: **Pragmatism > Idealism**  
"I chose X because it works for POC, but for production I'd consider Y" shows maturity.

---

## Career Discussion Guide

### The 5% Section: Role Flexibility & Timeline

**Context**: This conversation is not just a technical interview—it's a discussion about fit, timeline, and flexibility.
...
**Your Situation**:
- You have deep AI/ML skills (RAG, embeddings, LLM integration)
- You have full-stack skills (React, FastAPI, PostgreSQL, Qdrant)
- You're open to roles that leverage both, or focus on one

**Questions to Ask**:

- **"Is this role primarily AI/ML focused, or full-stack with AI components?"**  
  *Why*: Understand day-to-day work distribution. Some "AI roles" are 80% infrastructure.

- **"What's the team composition? Pure ML engineers, or mixed full-stack?"**  
  *Why*: Understand if you'll be the only AI person (risky—knowledge silo) or part of a team.

- **"Are there opportunities to specialize in AI/ML over time, or is the role broadly full-stack?"**  
  *Why*: Clarify growth path—can you become the RAG expert, or will you context-switch constantly?

**Your Flexibility Statement**:

*"I'm flexible on the role focus. I enjoy full-stack work—building end-to-end features—but I'm particularly excited about AI/ML challenges like RAG, embeddings, and LLM orchestration. If the role has a good balance of both, that's ideal. If it's more full-stack initially with a path toward AI work, I'm open to that too."*

#### 2. Timeline & Start Date

**Your Situation**:
- You have existing commitments (specify if relevant: current job notice period, personal timeline)
- You need clarity on when the company expects you to start

**Questions to Ask**:

- **"What's the ideal start date for this role?"**  
  *Why*: Understand urgency—is this a "start next week" or "start in 2 months" role?

- **"Is there flexibility on the start date if we're a good fit?"**  
  *Why*: Assess if you can negotiate timeline.

- **"What's driving the timeline? (Project deadline, team capacity)"**  
  *Why*: Understand if timeline is hard constraint or soft preference.

**Your Timeline Statement**:

*"I'm very interested in this role and would be excited to start as soon as possible. That said, I have [commitments / notice period / personal timeline] that would require [X weeks]. If the team's timeline is flexible, I'd love to work toward [specific start date]. If there's urgency, I'm happy to discuss ways to accelerate."*

#### 3. Alignment on Expectations

**Your Situation**:
- You've built a POC to demonstrate skills
- You want to ensure the role matches your skills and interests

**Questions to Ask**:

- **"Based on this project, do you see me as a good fit for the role?"**  
  *Why*: Direct feedback—better to know now than after an offer.

- **"Are there any gaps you see between my background and the role requirements?"**  
  *Why*: Identify concerns early, address them proactively.

- **"What excites you most about this project in the context of the role?"**  
  *Why*: Understand what they value (security architecture? RAG implementation? full-stack skills?).

**Your Alignment Statement**:

*"I built this project to showcase both my AI/ML skills and my ability to deliver production-ready systems. The security architecture—ACL filtering, retrieval-time authorization—reflects how I think about real-world systems. If the role involves similar challenges—building secure, scalable AI features—I'm confident I'd be a strong fit. I'm excited to hear your thoughts."*

#### 4. What You're Looking For

**Your Situation**:
- You're evaluating the company as much as they're evaluating you
- You want clarity on culture, growth, impact

**Questions to Ask**:

- **"What does career growth look like for someone in this role?"**  
  *Why*: Understand long-term potential (IC track? Management track?).

- **"How does the team balance innovation (exploring new AI tech) with shipping features?"**  
  *Why*: Gauge if you'll have space to experiment or if it's purely execution-focused.

- **"What's the biggest lesson the team has learned in the past year?"**  
  *Why*: Insight into culture (do they reflect and improve, or just push forward?).

**Your Ideal Role Statement**:

*"I'm looking for a role where I can work on meaningful AI/ML problems with real-world impact, in a team that values both innovation and pragmatism. I want to learn from experienced engineers and contribute to a product that users love. This project represents the kind of work I'm excited to do—solving hard technical problems with clean, secure, scalable solutions."*

#### 5. Closing the Conversation

**Your Situation**:
- Interview is wrapping up, you want to leave a strong impression

**Strong Close Statement**:

*"Thank you for taking the time to review this project and discuss the role. I'm very excited about the opportunity. Based on our conversation, I believe my skills in [AI/ML, full-stack, security architecture] align well with what the team needs. I'm confident I could hit the ground running and contribute meaningfully. I'm flexible on [role focus, timeline] and eager to find a fit that works for both of us. What are the next steps?"*
